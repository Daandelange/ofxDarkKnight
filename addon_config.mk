...
meta:
	ADDON_NAME = ofxDarkKnight
	ADDON_DESCRIPTION = Node based programming environment for openframeworks.
	ADDON_AUTHOR = @luiscript
	ADDON_TAGS = "GUI"
	ADDON_URL = https://github.com/luiscript/ofxDarkKnight
...
common:
	...
	ADDON_DEPENDENCIES += ofxMeshWarp
	ADDON_DEPENDENCIES += ofxHapPlayer
	ADDON_DEPENDENCIES += ofxPostProcessing
	ADDON_DEPENDENCIES += ofxAutoReloadedShader
	ADDON_DEPENDENCIES += ofxFboRecorder
	ADDON_DEPENDENCIES += ofxLua
	ADDON_DEPENDENCIES += ofxThreadedFileDialog
